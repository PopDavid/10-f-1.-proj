...
def kikialtas():
    ...
    while val not in map(str, range(1, 4)):
        ...
        match val:
            ...
            case '3':
                ...
                val = ''
                while val not in map(str, range(1, 3)):
                    val = input('Választásod: ')
    ...
    Slowtype('[Király]: Adok 100 pénzt, hogy ne halj meg azonnal')
    Slowtype('[Király]: Ha meghalsz 10-szeresét fizeti a családod vissza nekem')
    money += 100
